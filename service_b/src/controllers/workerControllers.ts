...
export const metricController = catchAsync(async (req: Request, res: Response) => {
...
//   const jobsProcessedMetric = metrics.find((m) => m.name === 'worker_jobs_processed_total');
//   const processingTimeMetric = metrics.find((m) => m.name === 'worker_job_processing_time_seconds');
