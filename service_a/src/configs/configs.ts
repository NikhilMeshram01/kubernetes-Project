...
export const PORT = Number(process.env.PORT) || 6001; // ensure PORT is a number

export const MONGODB_URI = getEnvVar('MONGODB_URI');

export const JWT_ACCESS_SECRET_KEY = getEnvVar('JWT_ACCESS_SECRET_KEY');
export const JWT_ACCESS_EXPIRES_IN: SignOptions['expiresIn'] = (process.env.JWT_ACCESS_EXPIRES_IN ||
